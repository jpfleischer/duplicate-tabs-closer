...
class TabsInfo {
  ...
  async initialize() {
    ...
    for (const openTab of openTabs) this.setNewTab(openTab, true);
  }
  ...
  removeTab(tabId) { this.tabs.delete(tabId); }
  hasTab(tabId)    { return this.tabs.has(tabId); }
...
export const tabsInfo = new TabsInfo();
export { TabsInfo };
